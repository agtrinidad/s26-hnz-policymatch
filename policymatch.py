...
with gr.Blocks(
    ...
    def chip_click(chip_text, history, api_key, hf_token, past_ctx, _sel):
        yield from run_search(chip_text, history, api_key, hf_token, past_ctx, chip_text)

    CHIP_COMMON = [chatbot, api_key_input, hf_token_input, past_context_state, selected_suggest_state]
